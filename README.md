...
> [!WARNING]
> This image is configured for the `yassin` account and fixed PCI devices `07:00.0`, `07:00.1`, and `09:00.4`. Review the machine-specific settings before using it elsewhere.
